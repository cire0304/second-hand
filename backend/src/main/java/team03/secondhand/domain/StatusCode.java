...
public enum StatusCode {
    ...
    TOKEN_INVALID(false, NOT_FOUND, 40100, "유효하지 않은 토큰입니다."),
    ...
    AUTHENTICATION_INVALID_USER(false, UNAUTHORIZED, 40104, "이용할 수 없는 사용자입니다."),
    DUPLICATED_USER(false, UNAUTHORIZED, 40105, "이미 회원가입된 사용자입니다."),
    NOT_FOUND_LOCATION(false, NOT_FOUND, 40106, "유효하지 않는 동네입니다."),
    NOT_FOUND_PLATFORM(false, NOT_FOUND, 40107, "유효하지 않는 플랫폼 입니다."),
    REQUIRED_SIGNUP(false, FORBIDDEN, 40301, "추가 회원가입이 필요한 사용자입니다.");
